...
from tasks.views import  TaskDetailView, TaskListView, TaskStatusDoneView, TaskStatusInProgressView, UserAssignTaskView, UserCompletedTasksView, UserTasksView
...
urlpatterns = [
    ...
    path('<int:pk>/assign/<int:user_id>/', UserAssignTaskView.as_view(), name='completed_tasks'),
